/**
 * Seed para desarrollo — crea un reclamo de ejemplo.
...
async function main() {
  ...
  await prisma.claim.create({
    data: {
      ...
      description:
        'El servicio de internet contratado no funciona correctamente desde hace 15 días. ' +
        'He llamado al servicio técnico en múltiples ocasiones sin solución.',
      consumerRequest:
        'Solicito la reparación inmediata del servicio o la devolución del monto pagado ' +
